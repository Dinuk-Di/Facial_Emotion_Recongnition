...
def recommendation_agent(state):
    ...
    prompt = f"""
       User is feeling {emotion} and is currently working on the screen task: {detected_task}.
        ...
        - 'recommendation': Suggestion to improve the mood. Give the most suitable option from the list:-["Listen to songs", "Watch funny videos", "Watch a movie", "Play Quick game", "Do painting"]
        - 'recommendation_options': list of 3 apps that is most suitable to accomplish the given recommendation. 
        The recommendation_options should be apps from the list eg:-[ Youtube, Spotify, Paint, Facebook, Instergram, Microsoft Solitaire Collection] or any other suitable. 
        Response Formate:
    ...
    try:
        ...
        valid_recommendation = ["Listen to songs", "Watch funny videos", "Watch a movie", "Play Quick game", "Do painting"]
